"""Tier 0: the portable jaxfne model-inspection renderers.

These are the packet's own acceptance tests and must stay free of jomission and TFNE
concepts, because the module they test is meant to be copied verbatim into jaxfne. They use
hand-built stand-ins exposing only the public surface: neuron_table() and
params["edge_list"].
"""
...
from jomission.visualization import jaxfne_vis as JV
